export default function EventSkeleton() {
  return (
    <div className='flex h-[450px] min-w-[350px] animate-pulse flex-col rounded-xl bg-background-secondary transition-all duration-500'>
      <div className='relative h-[250px] border-b border-border'>
        <div className='absolute -bottom-2.5 left-5 w-28 rounded-full bg-text-secondary py-3'></div>
      </div>
